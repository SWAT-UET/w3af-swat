...
5. Thông tin khác
6. Các profile: Có 6 prolife
7. Plugin dùng để quét lỗ hổng
8. Hiển thị thông tin chi tiết của plugin khi bạn chọn các plugin ở menu bên trái.
9. Nhập URL cần quét
...
1. Các bước thực hiện.
  ...
  Gõ: w3af
  Để thực hiện câu lệnh trên bạn phải cài đặt w3af_gui.
2. Tiến hành quét: VD: ctmail.vnu.edu.vn
  ...
  Chọn các profile(6) vd: chọn test
  Chọn các plugin(7): vd: chọn audit, 
